        ...
        if (c.getCount() > 0) {
            ...
            if (c.moveToFirst()) {
                ...
                do {
                    ...
                    dbname_name_arr[i] = c.getString(c.getColumnIndex("name"));
                    ...
                    text_slovary_item.setText(dbname_name_otobrajenie_arr[i]); item.getLayoutParams().width = LayoutParams.MATCH_PARENT;
                    ...
                    text_slovary_item.setOnClickListener(new OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            mainvozvrat(dbname_name_arr[v.getId()]);
        ...
        if (cursor != null) {
            if (cursor.getCount() > 0) {
                if (cursor.moveToFirst()) {
                    ...
                    //final int jjj = c.getCount();
                    do {
                        if (dbname_checked_arr[i]){
                            database.execSQL("drop table if exists " + dbname_name_arr[i] +";");
